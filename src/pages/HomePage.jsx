...
import { genHorarios } from "../helper/genHorario";
...
export default function HomePage() {
  ...
  useEffect(() => {}, [asignacionId]);

  useEffect(() => {}, [materias]);

  useEffect(() => {}, [selectedMateria]);

  useEffect(() => {}, [asignaciones]);
    ...
    <>
      <div className="flex pt-14">
        ...
        <div className="flex-col w-full bg-gray-200 overflow-y-auto h-screen">
          ...
          <div className="flex justify-around gap-3 mx-3 mt-4 bg-white rounded-md border shadow-md p-2">
            {grupo && (
          ...
          <div className="flex justify-end gap-3 mx-3 mt-4 bg-white rounded-md border shadow-md p-2">
            <button
              className="bg-amber-500 hover:bg-amber-800 text-white rounded-md p-2 flex gap-1"
              onClick={() => genHorarios(asignaciones)}
            >
              <img
